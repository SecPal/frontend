...
export function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <main className="min-h-[var(--app-shell-min-height)] bg-white px-4 pt-[calc(1.5rem+var(--app-safe-area-inset-top))] pb-6 text-zinc-950 dark:bg-zinc-950 dark:text-white sm:px-6 lg:px-8">
