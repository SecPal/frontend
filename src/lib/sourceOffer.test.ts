...
describe("loadSourceOffer", () => {
  ...
  it("rejects manifest repositories that point to moving GitHub latest-release aliases", async () => {
    const fetchMock = createResponseRouter({
      "/source-offer.json": new Response(
        JSON.stringify({
          version: 1,
          repositories: {
            frontend: {
              sourceUrl:
                "https://github.com/SecPal/frontend/releases/latest/download/source.tar.gz",
            },
            contracts: {
              sourceUrl:
                "https://github.com/SecPal/contracts/releases/download/contracts-2026-06-26/source.tar.gz",
  ...
  it("rejects manifest repositories that point to mutable GitHub branch pages", async () => {
    const fetchMock = createResponseRouter({
      "/source-offer.json": new Response(
        JSON.stringify({
          version: 1,
          repositories: {
            frontend: {
              sourceUrl: "https://github.com/SecPal/frontend/tree/main",
            },
            contracts: {
              sourceUrl:
                "https://github.com/SecPal/contracts/releases/download/contracts-2026-06-26/source.tar.gz",
  ...
  it("rejects manifest repositories that point to mutable GitHub codeload branch archives", async () => {
    const fetchMock = createResponseRouter({
      "/source-offer.json": new Response(
        JSON.stringify({
          version: 1,
          repositories: {
            frontend: {
              sourceUrl:
                "https://codeload.github.com/SecPal/frontend/tar.gz/refs/heads/main",
            },
            contracts: {
              sourceUrl:
                "https://github.com/SecPal/contracts/releases/download/contracts-2026-06-26/source.tar.gz",
  ...
  it("rejects API release metadata that points to moving GitHub latest-release aliases", async () => {
    const fetchMock = createResponseRouter({
      "/source-offer.json": new Response(
        JSON.stringify({
          version: 1,
      ...
      "/v1/release": new Response(
        JSON.stringify({
          data: {
            version: "api-2026-06-26",
            source_url:
              "https://github.com/SecPal/api/releases/latest/download/source.tar.gz",
          },
        }),
        {
          status: 200,
  ...
  it("rejects API release metadata that points to mutable GitHub blob pages", async () => {
    const fetchMock = createResponseRouter({
      "/source-offer.json": new Response(
        JSON.stringify({
          version: 1,
      ...
      "/v1/release": new Response(
        JSON.stringify({
          data: {
            version: "api-2026-06-26",
            source_url: "https://github.com/SecPal/api/blob/main/source.tar.gz",
          },
        }),
        {
          status: 200,
  ...
  it("rejects API release metadata that points to mutable GitHub codeload branch archives", async () => {
    const fetchMock = createResponseRouter({
      "/source-offer.json": new Response(
        JSON.stringify({
          version: 1,
      ...
      "/v1/release": new Response(
        JSON.stringify({
          data: {
            version: "api-2026-06-26",
            source_url:
              "https://codeload.github.com/SecPal/api/zip/refs/heads/main",
          },
        }),
        {
          status: 200,
