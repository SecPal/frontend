...
export const SUBMITTED_ONBOARDING_WORKFLOW_STATUSES =
  new Set<EmployeeOnboardingWorkflowStatus>([
...
export function isSubmittedOnboardingWorkflowStatus(
  ...
  return (
    status !== undefined && SUBMITTED_ONBOARDING_WORKFLOW_STATUSES.has(status)
  );
}
